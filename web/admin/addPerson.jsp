...
<div class="jumbotron container">
    <h1>添加学生数据</h1>
    <!--表单的设计参考了https://www.runoob.com/html/html-forms.html -->
    <form name="addPerson" method="post" action="${pageContext.request.contextPath}/add.do">
        <label for="name">姓名</label><br>
        <input type="text" name="name" id="name" maxlength="20" placeholder="姓名"><br>
        <label for="stuID">学号</label><br>
        <input type="number" name="stuID" id="stuID" maxlength="10" placeholder="学号"><br>
        <label for="age">年龄</label><br>
        <input type="number" name="age" id="age" maxlength="3" placeholder="年龄"><br>
        性别<br>
        ...
        <input type="number" name="grade" id="grade" maxlength="4" placeholder="年级"><br>
        学院与专业<br>
        ...
        <!--这里和updatePerson.jsp使用的back();函数参考了：
        https://www.cnblogs.com/ln0808/p/9922957.html-->
    </form>
</div>
</form>
</body>
